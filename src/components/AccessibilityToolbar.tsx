...
export const AccessibilityToolbar = () => {
  ...
  return (
    ...
    >
      <div className={`flex flex-col gap-2 bg-card/95 backdrop-blur-sm p-3 rounded-lg shadow-glow border-2 transition-all duration-300 ${isExpanded ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
        <Button
      ...
      <div className={`absolute inset-0 flex items-center justify-center transition-all duration-300 ${isExpanded ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <Button
          variant="default"
          size="icon"
